...
class Register extends React.Component {
    ...
    onSubmitSignIn = () => {
        fetch('https://secure-taiga-25819.herokuapp.com/register',{
            method: 'post',
    ...
    return (
        <article className="br3 ba dark-gray b--white-10 mv4 w-100 w-50-m w-25-l mw6 shadow-5 center">
            ...
            <fieldset id="sign_up" className="ba b--transparent ph0 mh0">
                ...
                <input 
                className="pa2 input-reset ba  hover-bg-white hover-black w-100" 
                type="text" 
                name="name"  
                id="name" 
                ...
                <input 
                className="b pa2 input-reset ba hover-bg-white hover-black w-100" 
                type="password" 
                name="password"  
                id="password" 
